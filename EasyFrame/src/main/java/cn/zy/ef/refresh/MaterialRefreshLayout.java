 ...
 * @version 1.0
 * @date 16-11-3
 * @des MaterialRefreshLayout.java
 * <p>
 * <p>
 * <p>
 * <p>
 ...
 * app:overlay="false"    //是否覆盖
 * app:progress_backgroud_color="#FFFAFAFA"   //进度条被背景
 * app:progress_colors="@array/material_colors"  //进度条颜色
 * app:progress_show_arrow="false"  //是否显示箭头
 * app:progress_show_circle_backgroud="true"  //是否显示进度条精度条背景
 * app:wave_color="#20ff2020"   //是否显示下拉波纹
 * app:wave_height_type="normal"  //波纹高度
 * app:wave_show="true"   //是否显示波纹
 * >
 * <p>
 * </MaterialRefreshLayout>
 */
public class MaterialRefreshLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        setWaveHeight(DensityUtil.dip2px(context, waveHeight));
        setHeaderHeight(DensityUtil.dip2px(context, headHeight));

        if (isSunStyle) {
            mSunLayout = new SunLayout(context);
            LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DensityUtil.dip2px(context, hIGHER_HEAD_HEIGHT));
        ...
        LayoutParams layoutParams2 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DensityUtil.dip2px(context, hIGHER_HEAD_HEIGHT));
...
//    }
    ...
    public MaterialHeaderView getmMaterialHeaderView() {
        return mMaterialHeaderView;
    }

    public MaterialFooterView getmMaterialFooterView() {
        return mMaterialFooterView;
    }
