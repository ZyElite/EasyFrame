...
import cn.zy.ef.R;
import cn.zy.ef.refresh.Footer.BottomProgressView;
import cn.zy.ef.refresh.header.GoogleDotView;
import cn.zy.ef.refresh.utils.ScrollingUtil;
...
public class RefreshLayout extends RelativeLayout {
    ...
    public RefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mWaveHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_wave_height, DensityUtil.dip2px(context, 120));
        mHeadHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_head_height,  DensityUtil.dip2px(context, 80));
        mBottomHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_bottom_height, DensityUtil.dip2px(context, 60));
        mOverScrollHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_overscroll_height, (int) mHeadHeight);
        enableLoadmore = a.getBoolean(R.styleable.RefreshLayout_enable_loadmore, true);
        isPureScrollModeOn = a.getBoolean(R.styleable.RefreshLayout_pureScrollMode_on, false);
        isOverScrollTopShow = a.getBoolean(R.styleable.RefreshLayout_overscroll_top_show, true);
        isOverScrollBottomShow = a.getBoolean(R.styleable.RefreshLayout_overscroll_bottom_show, true);
        enableOverScroll = a.getBoolean(R.styleable.RefreshLayout_enable_overscroll, true);
        a.recycle();
    ...
    public void setWaveHeight(float waveHeightDp) {
        this.mWaveHeight = DensityUtil.dip2px(getContext(), waveHeightDp);
    }
