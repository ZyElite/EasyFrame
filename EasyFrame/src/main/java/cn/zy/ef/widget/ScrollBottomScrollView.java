...
public class ScrollBottomScrollView extends ScrollView {
    private static final String TAG = ScrollBottomScrollView.class.getSimpleName();
    // 检查ScrollView的最终状态
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                checkStateHandler.sendEmptyMessageDelayed(CHECK_STATE, 1000);// 5毫秒检查一下
    ...
    private Handler checkStateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (lastT == getScrollY()) {
                ...
                onScrollListener.onScrollStateChanged(ScrollBottomScrollView.this,
                        OnScrollListener.SCROLL_STATE_IDLE);
                // from http://blog.chinaunix.net/uid-20782417-id-1645164.html
                if (getScrollY() + getHeight() == computeVerticalScrollRange()&&!isBottom) {
                    if (!isBottom){
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChanged(ScrollBottomScrollView view,
                                         int scrollState);
