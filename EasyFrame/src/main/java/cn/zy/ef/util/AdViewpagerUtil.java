        ...
        if (urls.length > 0) {
            ...
            for (int i = 0; i < length; i++) {
                if (i < length - 2) {
                    ...
                    ImageLoader.display(context, mImageViews[i + 1], url);
            ...
            ImageLoader.display(context, mImageViews[0], urls[urls.length - 1]);
            ImageLoader.display(context, mImageViews[length - 1], urls[0]);
        }
    }
